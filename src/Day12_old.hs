...
validCombosFor :: String -> [Int] -> [String]
validCombosFor s combo = uniq (filter (\thisStr -> thisStr `matches` s && fitsPattern thisStr combo) $ allPossibilities s combo)
